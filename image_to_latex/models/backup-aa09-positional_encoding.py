...
class PositionalEncoding2D(nn.Module):
    ...
    def __init__(self, d_model: int, max_h: int = 2000, max_w: int = 2000) -> None:
        ...
        # self.pe = self.make_pe(d_model, max_h, max_w)  # (d_model, max_h, max_w)
